...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Drip.trigger_model'
        db.add_column('drip_drip', 'trigger_model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Drip.trigger_model'
        db.delete_column('drip_drip', 'trigger_model_id')
    ...
    models = {
        ...
        'drip.drip': {
            ...
            'trigger_model': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'})
        },
        'drip.querysetrule': {
